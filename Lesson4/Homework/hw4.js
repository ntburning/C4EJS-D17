...
// const task = {
//     subject: 'Implement',
//     createdBy: 'Nguyen Trung Hieu',
//     assignTo: 'Tran Minh Quang',
//     dueDate: '4/8/2020',
//     expectedHours: 0.5,
// }
...
// //let wordSearch = prompt("Enter a keyword")
...
//     }
//     if (count==0){
//         let newWord = prompt ("We could not find " + wordSearch + ", explanation plz")
//         dictionary[wordSearch] = newWord
//         alert ("Done")
//     }   
// }
...
//while(true){
    ...
    // for (let i = 0; i<product.length; i++){
    //     for (let j = 0; j<=product[i].Providers.length; j++){
    //         if (product[i].Providers[j]==prov){
    //            console.log(`Name: ${product[i].Name} \nPrice: ${product[i].Price} `)
    //         }
    //     }
    // }
...
//6.1
console.log("Hi there, this is your learning tasks to front-end: \n")
